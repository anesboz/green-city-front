...
export class MapEvented<
  P,
  E extends Leaflet.Evented
...
export class DivOverlay<
  P extends DivOverlayProps,
  E extends DivOverlayTypes
...
export interface SVGOverlayProps
  extends Leaflet.ImageOverlayOptions,
    MapComponentProps {
  children?: Children | undefined
...
export interface VideoOverlayProps
  extends Leaflet.VideoOverlayOptions,
    MapComponentProps {
  attribution?: string | undefined
